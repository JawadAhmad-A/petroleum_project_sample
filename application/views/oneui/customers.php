              ...
              <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center">
                <div class="d-flex flex-column flex-md-row align-items-start align-items-md-center">
                  ...
                  <div class="d-flex d-md-none mb-2 justify-content-between w-100">
                    <div class="dropdown">
                      ...
                      <ul class="dropdown-menu" aria-labelledby="contactsDropdown">
                        ...
                        <li><a class="dropdown-item active" href="<?php echo base_url('contacts/customers'); ?>">Customers</a></li>
                    ...
                    <a href="<?php echo base_url('contacts/newcustomer'); ?>" class="btn btn-primary btn-sm">
                      <i class="fa fa-plus opacity-50 me-1"></i> New Customer
                    </a>
                  </div>
                  ...
                  <div class="d-none d-md-flex flex-wrap gap-2">
                    ...
                    <a href="<?php echo base_url('contacts/customers'); ?>" class="btn btn-link active" style="color: #0d6efd !important; text-decoration: none;">Customers</a>
              ...
              <table class="js-table-checkable table table-hover table-vcenter">
                ...
                <tbody>
                  <tr>
                    ...
                    <td class="fs-sm">
                      <p class="fw-semibold mb-1">
                        <a href="<?php echo site_url('contacts/customer'); ?>">Lori Moore</a>
                      </p>
                  ...
                  <tr>
                    ...
                    <td class="fs-sm">
                      <p class="fw-semibold mb-1">
                        <a href="<?php echo site_url('contacts/customer'); ?>">Wayne Garcia</a>
                      </p>
                      <p class="text-muted mb-0">
                        Customer details and further information
                      </p>
