          ...
          <div class="d-flex flex-column flex-md-row justify-content-md-between align-items-md-center py-2 text-center text-md-start">
            <div class="flex-grow-1 mb-1 mb-md-0">
              ...
              <h2 class="h6 fw-medium fw-medium text-muted mb-0">
                Welcome <a class="fw-semibold" href="<?php echo base_url('profile'); ?>"><?php echo $fullname; ?></a>, everything looks great.
              </h2>
            </div>
        ...
        <div class="content">
          ...
          <div class="block block-rounded">
              ...
              <div class="block-options space-x-1">
                ...
                <div class="dropdown d-inline-block">
                  ...
                  <div class="dropdown-menu dropdown-menu-md dropdown-menu-end fs-sm" aria-labelledby="dropdown-recent-orders-filters">
                    <a class="dropdown-item fw-medium d-flex align-items-center justify-content-between" href="javascript:void(0)">
                      Draft
                      <span class="badge bg-primary rounded-pill"><?php echo $draft_count; ?></span>
                    </a>
                    <a class="dropdown-item fw-medium d-flex align-items-center justify-content-between" href="javascript:void(0)">
                      Sent
                      <span class="badge bg-primary rounded-pill"><?php echo $sent_count; ?></span>
                    </a>
                    <a class="dropdown-item fw-medium d-flex align-items-center justify-content-between" href="javascript:void(0)">
                      Paid
                      <span class="badge bg-primary rounded-pill"><?php echo $paid_count; ?></span>
                    </a>
                    <a class="dropdown-item fw-medium d-flex align-items-center justify-content-between" href="javascript:void(0)">
                      All
              ...
              <form action="" method="POST" onsubmit="return false;">
                <div class="push">
                  <div class="input-group">
                    <input type="text" class="form-control form-control-alt" id="one-ecom-orders-search" name="one-ecom-orders-search" placeholder="Search all invoices..">
            ...
            <div class="block-content block-content-full">
                ...
                <table class="table table-hover table-vcenter">
                  <thead>
                    <tr>
                      ...
                      <th>Status</th>
                      <th class="d-none d-sm-table-cell text-end">Due Date</th>
                  ...
                  <tbody class="fs-sm">
                    ...
                    <tr>
                      <td>
                        <a class="fw-semibold" href="<?php echo site_url('invoicing/view/'.$invoice->id); ?>">
                          <?php echo $invoice->invoice_number; ?>
                        </a>
                        <p class="fs-sm fw-medium text-muted mb-0"><?php echo $invoice->reference; ?></p>
                      </td>
                      <td class="d-none d-xl-table-cell">
                        <a class="fw-semibold" href="<?php echo site_url('customers/view/'.$invoice->customer_id); ?>">
                          <?php echo $invoice->first_name . ' ' . $invoice->last_name; ?>
                        </a>
                        <p class="fs-sm fw-medium text-muted mb-0"><?php echo $invoice->account_name; ?></p>
                      </td>
                      <td>
                        <?php
                        switch($invoice->status) {
                          case 'draft':
                            $status_class = 'bg-warning-light text-warning';
                            break;
                          case 'sent':
                            $status_class = 'bg-info-light text-info';
                            break;
                          case 'paid':
                            $status_class = 'bg-success-light text-success';
                            break;
                          case 'overdue':
                            $status_class = 'bg-danger-light text-danger';
                            break;
                        }
                        ?>
                        <span class="fs-xs fw-semibold d-inline-block py-1 px-3 rounded-pill <?php echo $status_class; ?>">
              ...
              <!-- END Recent Invoices Table -->
            </div>
            <div class="block-content block-content-full bg-body-light">
              <!-- Pagination -->
              <nav aria-label="Invoices Navigation">
