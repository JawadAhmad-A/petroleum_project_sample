        ...
        <!-- Hero -->
        <div class="bg-image" style="background-image: url('<?php echo base_url(); ?>backend/oneui/assets/media/photos/photo10@2x.jpg');">
          <div class="bg-primary-dark-op">
            <div class="content content-full text-center">
              <div class="my-3">
                <img class="img-avatar img-avatar-thumb" src="<?php echo base_url(); ?>backend/oneui/assets/media/avatars/avatar13.jpg" alt="">
              </div>
              <h1 class="h2 text-white mb-0">Edit Account</h1>
              <h2 class="h4 fw-normal text-white-75">
                <?php echo $fullname; ?>
              </h2>
              <a class="btn btn-alt-secondary" href="<?php echo base_url('dashboard'); ?>">
                ...
                <div class="row push">
                  ...
                  <div class="col-lg-8 col-xl-5">
                    ...
                    <div class="mb-4">
                      ...
                      <input type="email" class="form-control" id="one-profile-edit-email" name="one-profile-edit-email" placeholder="Enter your email.." value="<?php echo $email; ?>">
                    </div>
                    <div class="mb-4">
                      <label class="form-label">Your Avatar</label>
                      <div class="mb-4">
                        <img class="img-avatar" src="<?php echo base_url(); ?>backend/oneui/assets/media/avatars/avatar13.jpg" alt="">
                      </div>
                      <div class="mb-4">
