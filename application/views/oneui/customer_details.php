        <!-- Hero -->
        <div class="bg-image" style="background-image: url('<?php echo base_url(); ?>backend/oneui/assets/media/photos/photo12@2x.jpg');">
                ...
                <div class="block-content">
                  <div class="fs-sm push">
                    <div class="d-flex justify-content-between mb-2">
                      <div>
                        <a class="fw-semibold" href="">Jack Estrada</a>
