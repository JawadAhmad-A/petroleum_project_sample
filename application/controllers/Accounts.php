...
class Accounts extends CI_Controller {
    ...
    function getLists(){
        ...
        foreach($accountsData as $account){
            ...
            $data[] = array('',$i, $account->AccountID, $account->AccountTitle, $account->AccountType, $account->OpeningBalance, $account->CreditLimit, $account->Address, $account->City, $account->Phone, $status);
        }
